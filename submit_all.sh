...
set -x
qsub "${options[@]}" -l f_node=1 -l h_rt='01:00:00' -t 1-12 -N future_ahe generate_ahe.sh future 2050 popden_2050.tif
qsub "${options[@]}" -l f_node=1 -l h_rt='01:00:00' -t 1-12 -N present_ahe generate_ahe.sh present 2010 popden_2013.tif
